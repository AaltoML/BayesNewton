...
# enforce_psd = False
# minibatch_size = [100, 500, 100]
minibatch_size = [400, 600, 800, 2000, 3000]
# num_z = [1000, 1500, 2000]
num_z = [1500, 2000, 2500, 5000, 8000]
...
lik = gpflow.likelihoods.Gaussian(variance=likelihood_noise)
