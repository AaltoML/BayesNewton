...
kern1 = newt.kernels.Matern32(variance=var_f_mat, lengthscale=len_f_mat)
kern2 = newt.kernels.QuasiPeriodicMatern12(variance=var_f,
                                           lengthscale_periodic=len_p,
                                           period=period,
                                           lengthscale_matern=len_f)
kern = newt.kernels.Sum([kern1, kern2])
